...
from nanovllm_voxcpm.models.voxcpm.model import VoxCPMConfig, VoxCPMModel
...
class VoxCPMRunner(BaseModelRunner):
    ...
    def run(self, seqs: list[RunnerTask[VoxCPMPayload]], is_prefill: bool):
        ...
        for i in range(len(seqs)):
            ...
            if pad_len > 0:
                vae_decoder_inputs[i, :pad_len] = torch_from_numpy_writable(seqs[i].custom_payload.padding_decode).cuda(
                    non_blocking=True
                )
